  ...
  const addreview = async (e) => {
    if (user) {
      ...
      try {
        ...
        inventoryName: product.name, username: user, comment: comment, rating: rating,
  ...
  return (
    <div>
      ...
      <div style={{ margin: 100 }}>
        ...
        <label style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '15px', display: 'block' }}>
          Write your review:
        </label>
        <textarea
         value={comment}
        ...
        <button onClick={addreview} type="submit" style={{ backgroundColor: '#f0c14b', color: '#111', padding: '10px 20px', border: 'none', borderRadius: '4px', fontSize: '18px', cursor: 'pointer', marginTop: '20px' }}>Submit</button>
      </form>) :
        (<></>)
        }
